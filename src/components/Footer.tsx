...
export function Footer() {
  return (
    <footer
      id="contact"
      className="relative overflow-hidden border-t border-white/10 bg-black py-16 sm:py-20"
    >
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="grid size-11 place-items-center border border-white/12 text-xs font-bold text-white/60 transition hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-black"
        ...
        <div
          data-stagger
          className="mt-10 grid gap-6 border-t border-white/10 pt-8 lg:grid-cols-[1fr_auto] lg:items-center"
        >
          <nav
            data-stagger-item
